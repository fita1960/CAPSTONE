        ...
        <table class="table table-bordered table-striped mb-0">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT room.room_id, room.room_image, room.room_name, room_type.room_type_name, room.room_price, room.room_adult_count, room.room_child_count FROM room 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="includes/updateroom.inc.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <select class="form-select" aria-label="Default select example" name="room_type_id" id="room_type_id" value="<?php echo $rows['room_type_id']; ?>">
                                    <?php

                                    $sql = "SELECT room_type_id, room_type_name FROM room_type";
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="includes/addroom.inc.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="room_adult_count" class="form-label">Adult:</label>
                                <input type="text" class="form-control" id="room_adult_count" name="room_adult_count">
                            </div>
                            <div class="mb-3">
                                <label for="room_child_count" class="form-label">Children:</label>
                                <input type="text" class="form-control" id="room_child_count" name="room_child_count">
                            </div>
                            <div class="form-group">
