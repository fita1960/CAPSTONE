            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="includes/deletefacility.inc.php?id=<?php echo $rows["services_id"]; ?>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="includes/addservice.inc.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="services_name" class="form-label">Service Name:</label>
                                <input type="text" class="form-control" id="services_name" name="service_name" aria-describedby="services_name">
                            </div>
                            <div class="mb-3">
                                <label for="services_description" class="form-label">Service Description:</label>
                                <input type="text" class="form-control" id="services_description" name="services_description">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="file" name="file" value="" />
                            </div>
