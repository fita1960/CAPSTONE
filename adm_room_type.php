                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="includes/addroomtype.inc.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="room_type_name" class="form-label">Room Type:</label>
                                <input type="text" class="form-control" id="room_type_name" name="room_type_name" aria-describedby="room_type_name">
                            </div>
                            <div class="mb-3">
                                <label for="room_type_description" class="form-label">Description:</label>
                                <input type="text" class="form-control" id="room_type_description" name="room_type_description" aria-describedby="room_type_description">
                            </div>
                            <div class="modal-footer">
